...
**Full Stack Engineer** · Self-taught · Open to opportunities
...
### Full Stack Engineer — NSII *(3 years)*
> *Angular · Capacitor · Firebase · BLE · iOS* · Android*

Contributed to a cross-platform athlete safety platform for real-time head trauma monitoring using wearable sensors.
...
**Languages**
`Elixir` `Rust` `Kotlin` `TypeScript` `Python` `Javascript`
